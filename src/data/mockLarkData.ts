...
const master: LarkRecord[] = [
  ...
  { record_id: 'ma_prev', fields: { 'TV_MãNV': 'TC2', 'Trạng thái': HOAN_TAT, 'Họ và tên': 'Nguyễn Minh Long', 'Người': 'Thịnh_OPs', 'Thời gian': 1200, 'STT Input': '1', 'Thu lại máy': 'Thu máy sau', 'Scan QR máy cũ': 'MTC.1', 'Scan IMEI': '351234567890123', 'Hình nghiệm thu máy cũ': [{ file_token: 'MOCKTOKEN1', name: 'anh-cu-1.jpg' }] } },
  ...
  { record_id: 'ma_prev_bk', fields: { 'TV_MãNV': 'TC3', 'Trạng thái': HOAN_TAT, 'Họ và tên': 'Ngô Gia Huy', 'Người': 'Thịnh_OPs', 'Thời gian': 15400, 'STT Input': '15', 'Thu lại máy': 'Thu máy sau', 'Scan QR máy cũ': 'MTC.1', 'Scan IMEI': '860123456789012', 'Hình nghiệm thu máy cũ': [{ file_token: 'MOCKTOKEN_BK', name: 'bk-cu.jpg' }] } },
